    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-white rounded-lg shadow-lg p-8">
        ...
        <div className="flex justify-center mb-6">
          <img src="/Financfy Logo.png" alt="Financfy Logo" className="h-12" />
        </div>
        {/* Heading */}
        <h2 className="text-xl font-semibold text-center text-teal-700 mb-6">
          Start your journey with Financfy
        </h2>
        {/* Toggle Tabs */}
        <div className="flex justify-center mb-6">
          <button
        ...
        {isLogin ? (
          <form className="space-y-6">
            <h1 className="text-2xl font-semibold text-center text-teal-700">Welcome Back</h1>
            <div>
